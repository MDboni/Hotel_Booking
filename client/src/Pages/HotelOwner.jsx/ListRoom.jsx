...
const ListRoom = () => { 
  ...
  return (
    <div>
      <Title align='left'  font='outfit' title='Room Listings' subtitle='View, edit, or manage all listed rooms. keep the information up-to-date to provider the best experience for users.'/>
      <p className='text-gray-500 mt-8'>All Rooms</p>


      <div className='w-full mt-12 max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scrool'>
                ...
                <tbody className='text-sm'>
                    {
                      rooms.map((item,index)=>(
                        <tr key={index}>
                          ...
                          <td className='py-3 px-4 text-gray-700 border-t border-gray-300 mx-sm:hidden'>{item.amenities.join(',')}</td>
