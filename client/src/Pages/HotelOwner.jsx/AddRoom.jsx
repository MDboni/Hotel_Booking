...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title align='left' font='outfit' title='Add Room' subtitle='Fill in the Details careFully and accurate room details ,pricing, and amenities, to enhance the user booking expreince'/>
            ...
            <div className='w-full flex  max-sm:flex-col sm:gap-4 mt-4'>
              <div className='flex-1 max-w-48'>
                  ...
                  <select value={inputs.roomType} onChange={e=>setInputs({...inputs,roomType:e.target.value})} className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
                    ...
                    <option value="Singale Bed">Singale Bed</option>
                    <option value="Duble Bed">Duble Bed</option>
