...
const Footerr = () => {
  return (
    <div>
        <footer className="bg-[#bfc9d4] px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full  text-gray-500">
            <div className="flex flex-col  md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    <h2 className='text-3xl font-bold'>Boni Amin</h2>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            ...
                            <div className="flex items-center gap-2 pt-4">
                                ...
                                <button className="bg-gray-500 cursor-pointer w-24 h-9 text-white rounded">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2025 © <a href="">BONI AMIN(37)</a>. All Right Reserved.
            </p>
        </footer>
    </div>
  )
